@forelse($detcuti as $index => $detcuti)
    ...
    margin-top: 40px;" />
        ...
        <div style="padding-left: 20px; text-align: justify; font-size: 12pt">
            Selama {{ $detcuti->haricuti }} hari kerja/kalender, terhitung mulai tanggal {{ $detcuti->tanggalmulai }}
            sampai dengan tanggal {{ $detcuti->tanggalakhir }}, dengan ketentuan sebagai berikut:
        </div>
        <div style="text-align: justify; font-size: 12pt">
            <ol type="a">
                <li>Sebelum menjalankan Cuti Tahunan wajib menyerahkan pekerjaannya kepada atasan langsungnya atau
                    pejabat lain yang ditunjuk;
                </li>
                <li>
                    Setelah selesai menjalankan Cuti Tahunan, wajib melaporkan diri kepada atasan langsungnya dan
        ...
        <table width="100%" border="0" style="font-size: 12pt">
          ...
          /> --}}
            ...
            <tr>
                <td colspan="5" align="left">
                    <b
                        style="text-decoration: underline">{{ $detcuti->pegawai_namettd }}</b><br />{{ $detcuti->golru_namettd }}<br />NIP.
                    {{ $detcuti->pegawai_nipttd }}
                </td>
            </tr>
            <tr>
        ...
        <div class="page_break">
            ...
            <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    ...
                    <td colspan="3" style="border: 1px solid black; border-collapse: collapse;">
                        {{ $detcuti->golru_name }} / {{ $detcuti->golru_code }}</td>
                </tr>
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse;">Unit Kerja</td>
                    <td colspan="3" style="border: 1px solid black; border-collapse: collapse;">Dinas Penanaman Modal
                        Pelayanan Terpadu Satu Pintu</td>
                </tr>
            </table>
            <div style="height: 15px;"></div>
            <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px; padding-left:20px">1.
                        Cuti Tahunan</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        <div style="font-family: DejaVu Sans, sans-serif;">✔</div>
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">2.
                        Cuti Besar</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">3.
                        Cuti Sakit</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        <div style="width: 100px;height:40px"></div>
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">4.
                        Cuti Melahirkan</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        <div style="width: 100px;height:40px"></div>
                    </td>
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">5.
                        Cuti Karena Alasan Penting</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        <div style="width: 100px;height:40px"></div>
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">6.
                        Cuti di Luar Tanggungan Negara</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        <div style="width: 100px;height:40px"></div>
                    </td>
                </tr>
            ...
            <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        Tahun</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">Sisa
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        Keterangan</td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">3.
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">N-2
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">0
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        Sudah diambil </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">4.
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">N-1
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">0
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">N
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">12
                    </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">
                        Belum diambil </td>
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px">6.
            ...
            <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    ...
                    <td style="border: 1px solid black; border-collapse: collapse; widht: 100px;padding-left:20px; text-align:center"
                        colspan="2">
                        <div>
                            Hormat saya,
                            <br>
        ...
        <div class="page_break">
            ...
            <table style="border: 1px solid black; border-collapse: collapse; width: 100%">
                ...
                <tr style="border: 1px solid black; border-collapse: collapse;">
                    ...
                    <td style="border: 1px solid black; border-collapse: collapse;"colspan="2">KEPALA DINAS PENANAMAN
                        MODAL<br />PELAYANAN
                        TERPADU SATU PINTU<br />KABUPATEN SITUBONDO,<br><br><br><b
                            style="text-decoration: underline">{{ $detcuti->pegawai_namettd }}</b><br />{{ $detcuti->golru_namettd }}<br />NIP.
                        {{ $detcuti->pegawai_nipttd }}</td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    <td>**</td>
                    <td style="font-family: DejaVu Sans, sans-serif;">Pilih salah satu dengan member tanda centang (
                        ✔)</td>
                </tr>
                <tr>
                    <td>***</td>
